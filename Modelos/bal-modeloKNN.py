...
def entrenar_modelo(X_train, y_train):
    # Creamos el modelo de KNN de la librería
...
def probar_modelo(modelo, X_test, y_test, X_train, y_train):
    ...
    plt.savefig('../Imagenes/Balanceado/KNN/matriz_conf_KNN.png')
...
def trazar_ROC(model, X_test, y_test):
    ...
    plt.title('ROC de KNN Balanceado')
    plt.legend(loc="lower right", fontsize='small', ncol=2, title='Clases')
    plt.savefig('../Imagenes/Balanceado/KNN/ROC_KNN.png')
...
if __name__ == '__main__':
    ...
    guardar_modelo(modelo, '../Datos/Balanceado/modeloKNN.pkl')
